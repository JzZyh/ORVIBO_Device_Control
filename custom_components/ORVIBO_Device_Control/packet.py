...
class HomemateJsonData:
    ...
    @classmethod
    # ssl请求更新空调状态（使用CMD_STATE_UPDATE命令）
    def ssl_air_conditioner_state_update(cls,
                           username: str,
                           device_id: str,
                           device_mac: str,
                           value1: int,
    ...
    @classmethod
    # ssl请求更新新风设备状态（使用CMD_STATE_UPDATE命令）
    def ssl_ventilation_state_update(cls,
                           username: str,
                           device_id: str,
                           device_mac: str,
                           value1: int):
